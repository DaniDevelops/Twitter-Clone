...
const Post = ({ post }) => {
  ...
  const { mutate: toggleLikeFn, isLoading: isLiking } = useMutation({
    mutationFn: toggleClientLikes,
              ...
              >
                {isLiking ? (
                  ...
                  <FaRegHeart
                    className={
                      isLiked
                        ? "w-4 h-4 cursor-pointer text-slate-500 group-hover:text-pink-500"
                        : "w-4 h-4 cursor-pointer text-pink-500 "
                    }
                  />
                )}
                <span
